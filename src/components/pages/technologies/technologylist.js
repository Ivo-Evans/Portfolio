...
const projects = {
  ...
  snippetsOfCode: {
    title: "Snippets of Code - codesharing app",
...
export default [
  {
    ...
    interest: 5,
    comment:
      "I'm comfortable with HTML, but nowadays it seems like I write a lot more JSX. When I'm writing HTML, I endeavour to write it semantically.",
  },
  {
    icon: css3,
    name: "CSS3",
  ...
  },
  {
    ...
    interest: 5,
    comment:
      "JavaScript is my bread and butter. It is the language I 'think' in, and the language I go to when I need to make something difficult or something no-nonsense in a short space of time. I love JavaScript most for its usability across the stack, and least for its type coercion.",
  },
  {
    icon: typescriptIcon,
    name: "TypeScript",
  ...
  },
  {
    ...
    interest: 5,
    comment:
      "I'm well-used to React, and a fan primarily because of it's benefits to the developer experience. This site, like many of my projecs, is written in React.",
  ...
  },
  {
    ...
    experience: 5,
    interest: 5,
    comment: "I'm a big fan of ESLint. I generally opt for AirBnB config.",
    links: [projects.cardleyFrontend, projects.cardleyApi, projects.zaatari],
  },
  {
    icon: netlifyIcon,
    ...
    interest: 5,
    comment:
      "I'm comfortable with Netlify, having used it multiple times to deploy sites, send API queries with lambda functions, and configure DNS.",
  ...
  },
  {
    ...
    interest: 5,
    comment:
      "I'm very with Heroku. If there's a need for a quick and seamless server deployment, I'd certainly consider it. If price and performance are criteria, I'd generally opt for Google Cloud Platform.",
    links: [projects.cardleyApi, projects.snippetsOfCode],
  },
  {
  ...
  },
  {
    ...
    interest: 5,
    comment:
      "I'm a great fan of Docker. The mere idea of running an app inside a container, with total control of the environment, and then interfacing with the host operating system by exposing ports, is fascinating to me.",
    links: [projects.portfolio],
  },
  {
    icon: gitIcon,
    ...
    interest: 5,
    comment:
      "I'm certainly experienced with Git, and I appreciate it as a fundamental tool. At time of writing I've made ~1,700 commits to GitHub alone - you can bet your bucks that things have gotten gnarly a few times along the road. I even got into writing Husky extensions for a while, and so I've looked into advanced Git features like submodules and subtrees.",
  },
  {
    icon: githubOctocat,
    name: "GitHub",
  ...
  },
  {
    ...
    interest: 5,
    comment:
      "Figma is a useful prototyping tool. I appreciate it's prototype view, and the ability for multiple team-members to get on a design at once.",
